...
from tictactoefrontend.views import home, signup, find_opponent, multiplayer_setup_view, multiplayer_game_view, singleplayer_view, singleplayer_setup_view, handle_move, handle_multiplayer_move
...
urlpatterns = [
    ...
    path('multiplayer_move', handle_multiplayer_move, name='handle_multiplayer_move')
]
